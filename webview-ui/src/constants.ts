...
// ── Character Animation ─────────────────────────────────────
export const WALK_SPEED_PX_PER_SEC = 192;
...
export const MATRIX_SPRITE_COLS = 64;
export const MATRIX_SPRITE_ROWS = 96;
...
// ── Rendering ────────────────────────────────────────────────
export const CHARACTER_SITTING_OFFSET_PX = 24;
...
export const BUBBLE_SITTING_OFFSET_PX = 40;
export const BUBBLE_VERTICAL_OFFSET_PX = 96;
...
export const ZOOM_DEFAULT_DPR_FACTOR = 2; // legacy — retained for compatibility, no longer consumed
...
export const CHARACTER_HIT_HALF_WIDTH = 32;
